...
<head>
    ...
    <style>
        ...
        .banner-section::before {
            ...
            inset: 0;
            content: "";
            background: linear-gradient( 180deg, rgba(var(--base-14-rgb), 0.33) 0%, rgba(252, 252, 252, 0.31) 100% );
        }
        ...
        .banner-section::before {
            background: #f7f6f6;
            /* background-image: url(https://dijo.app/storage/app/public/header_image/2023-07-30-64c64afc8bf5a.png); */
        }
    </style>
    <script async src=https://www.googletagmanager.com/gtag/js?id=G-ZQZ9NHW86T></script> 
    <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-ZQZ9NHW86T'); </script> 
</head>
                ...
                <div class="container">
                    <div class="footer-wrapper ps-xl-5">
                                ...
                                @if (isset($social_media))
                                    ...
                                    <li>
                                        <a class="social-btn" target="_blank" href="{{ $social->link }}">
                                            <i class="fab fa-{{ $social->name }} fa-2x" aria-hidden="true" style="color:black;"></i>
                                        </a>
                                    </li>
                                    @endforeach
                                @endif
                        ...
                        <div class="footer-widget widget-links">
                            <h5 class="subtitle mt-2" style="color:black;">{{ translate('messages.quick_links') }}</h5>
                            <ul>
                                <li>
                        ...
                        <div class="footer-widget widget-links">
                            <h5 class="subtitle mt-2" style="color:black;">{{ translate('messages.contact_us') }}</h5>
                            <ul>
                                <li>
                    ...
                    <div class="copyright text-center mt-3" style="color:black;">
